# Generated by Powerlevel10k configuration wizard on 2024-12-27 at 10:02 UTC.
...
() {
  ...
  function prompt_project() {
    info=$(module list 2>/dev/null | grep -oP "project.*" | awk -F'/' '{print $2}' | sed 's/ //g')
    p10k segment -b 0 -f 4 -i '⭐' -t "$info" -c "$info"
  }
